...
partial class ReportPortalReporterMessageHandler
{
    ...
    private readonly ConcurrentDictionary<string, ITestReporter> _nestedScopes = new();
    ...
    private readonly Dictionary<Shared.Execution.Logging.LogScopeStatus, Status> _nestedStepStatusMap = new()
    {
